...
if __name__ == "__main__":
    ...
    _write_vtp_files(join(test_data_path, "vtp_test_file"))
    print("Writing test vts files")
    _write_vts_files(join(test_data_path, "vts_test_file"))
    print("Writing test vtr files")
    _write_vtr_files(join(test_data_path, "vtr_test_file"))
    print("Writing test vti files")
    _write_vti_files(join(test_data_path, "vti_test_file"))
